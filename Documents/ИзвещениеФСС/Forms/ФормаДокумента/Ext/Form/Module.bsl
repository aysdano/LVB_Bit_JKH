...
Процедура ОбновитьВидимостьДоступность()
	...
	ЭтоИзвещениеОПредставленииНедостающихСведений = ЭтоИзвещениеОПредставленииНедостающихСведений();
	
	Элементы.Сотрудник.Видимость = (
		ЭтоИзвещениеОПредставленииНедостающихСведений
	...
	Элементы.ГруппаРанееОтправленныеСведения.Видимость = ЭтоИзвещениеОПредставленииНедостающихСведений;
	Элементы.ГруппаНовыеСведения.Видимость             = ЭтоИзвещениеОПредставленииНедостающихСведений;
	Элементы.ОбработаноВШапке.Видимость                = Не ЭтоИзвещениеОПредставленииНедостающихСведений;
	
	Если ЭтоИзвещениеОПредставленииНедостающихСведений Тогда
...
Процедура ОбновитьРеквизитыОшибкаПриПоискеСотрудника()
	...
	Попытка
		...
		КонецЕсли;
	Исключение
		ЗарплатаКадрыОтображениеОшибок.СообщитьПользователю(ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
	КонецПопытки;
КонецПроцедуры
