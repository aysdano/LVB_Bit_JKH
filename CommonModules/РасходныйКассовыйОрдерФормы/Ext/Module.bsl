...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	// БИТ_ЖКХ 13.03.2017 14:39:06 Начало правки... 
	// БИТ_ЖКХ 10.03.2015{{
	Если Форма.Параметры.Свойство("ЗаполнитьИзАРМКассира") Тогда
		Объект.ВидОперации = Форма.Параметры.ЗаполнитьИзАРМКассира.ВидОперации;
	КонецЕсли;
	// БИТ_ЖКХ 10.03.2015}}
	// БИТ_ЖКХ 13.03.2017 14:39:08 Конец правки. 
