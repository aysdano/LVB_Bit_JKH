...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(ФильтрПодразделение) И Не ЗначениеЗаполнено(ФильтрОрганизация) Тогда
...
Процедура ОбновитьПараметрыСписка()
	...
	Список.Параметры.УстановитьЗначениеПараметра("Организация", ФильтрОрганизация);
