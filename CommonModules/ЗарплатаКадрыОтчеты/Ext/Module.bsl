...
Функция СохраненныйМакетКомпоновкиДанныхОтчета(Отчет, КлючВарианта)
	...
	Если Не РезультатЗапроса.Пустой() Тогда
		...
		Если Выборка.ВерсияКонфигурации = бит_ОбщегоНазначенияПовтИсп.ПолучитьНомерРелиза_1С() Тогда
...
Процедура ЗапомнитьМакетКомпоновкиДанных(Отчет, КлючВарианта, МакетКомпоновкиДанных) Экспорт
	...
	Попытка
		...
		Запись.ВерсияКонфигурации = бит_ОбщегоНазначенияПовтИсп.ПолучитьНомерРелиза_1С();
