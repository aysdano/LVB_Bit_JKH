...
Процедура ИзменитьВидУставаПриИзменении(Элемент)
	...
	Если ИзменитьВидУстава И ВидУстава = ЗначениеТиповойУстав() Тогда
...
Процедура ВидУставаПриИзменении(Элемент)
	...
	Если ВидУстава = ЗначениеТиповойУстав() Тогда
		НомерТиповогоУстава = РегистрацияОрганизацииКлиентСервер.НомерУставаПоУмолчанию();
	Иначе
		НомерТиповогоУстава = 0;
	КонецЕсли;
...
Процедура УправлениеЗакладкойЗаявление(Форма)
	...
	Если ЭтоФорма2014(Форма.ВыбраннаяФорма) Тогда
		Элементы.ЗаявительEMailПредставление.Видимость = Истина;
		Элементы.ГруппаСпособПолученияДокументов.Видимость = Ложь;
	Иначе
		Элементы.ЗаявительEMailПредставление.Видимость = Ложь;
...
Процедура УправлениеЗакладкойДокументы(Форма)
	...
	Если Форма.ОтображатьШагУстав Тогда
		...
		ЭтоИндивидуальныйУстав = ИзмененияВносятсяВУчредительныеДокументы И Не Форма.ИзменитьВидУстава
			Или Не ВыбранТиповойУстав(Форма.ВидУстава) И Форма.ИзменитьВидУстава;
		...
		Элементы.Устав.Видимость          = ЭтоИндивидуальныйУстав;
		Элементы.ТиповойУстав.Видимость   = Не ЭтоИндивидуальныйУстав И Форма.ИзменитьВидУстава;
