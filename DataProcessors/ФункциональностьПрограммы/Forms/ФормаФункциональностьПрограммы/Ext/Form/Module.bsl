...
Процедура ОбработатьНажатиеОшибки(Элемент, ИмяЗаголовка)
	...
	ИначеЕсли ИмяЭлемента = "ИспользоватьВыпускПродукции" Тогда
		ЗапуститьФормированиеСпискаДокументовПрепятствующихОтключениюОпцииНаКлиенте("ИспользоватьВыпускПродукции");
	...
	ИначеЕсли ИмяЭлемента = "ИспользоватьРаботуНаНеполнуюСтавку" Тогда
		ЗапуститьФормированиеСпискаДокументовПрепятствующихОтключениюОпцииНаКлиенте("ИспользоватьРаботуНаНеполнуюСтавку");
