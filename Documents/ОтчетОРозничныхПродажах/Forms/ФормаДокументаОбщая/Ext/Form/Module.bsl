...
Процедура ВозвратыДатаРеализацииПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(ТекущиеДанные.ДатаРеализации) Тогда
		НоваяСтавкаНДС = СтавкаНДСНаДату(ТекущиеДанные.ДатаРеализации, ТекущиеДанные.Номенклатура);
...
&НаСервереБезКонтекста
Функция СтавкаНДСНаДату(ДатаРеализации, Номенклатура)

	ВидСтавкиНДС = Справочники.Номенклатура.ВидСтавкиНДСНаДату(Номенклатура, ДатаРеализации);
	
	Возврат Перечисления.СтавкиНДС.СтавкаНДС(ВидСтавкиНДС, ДатаРеализации);
