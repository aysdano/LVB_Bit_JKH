...
Функция НоменклатураПоШтрихкодам(СписокШтрихкодов, ТочноеСоответствие) Экспорт
	...
	|	ЕСТЬNULL(СправочникНоменклатура.МолочнаяПродукцияПодконтрольнаяВЕТИС, ЛОЖЬ) КАК МолочнаяПродукцияПодконтрольнаяВЕТИС,
	|	ЕСТЬNULL(СправочникНоменклатура.МолочнаяПродукцияБезВЕТИС, ЛОЖЬ) КАК МолочнаяПродукцияБезВЕТИС,
	|	ЕСТЬNULL(СправочникНоменклатура.Шины, ЛОЖЬ) КАК Шины,
	|	ЕСТЬNULL(СправочникНоменклатура.АльтернативныйТабак, ЛОЖЬ) КАК АльтернативныйТабак,
	|	ЕСТЬNULL(СправочникНоменклатура.УпакованнаяВода, ЛОЖЬ) КАК УпакованнаяВода,
...
Функция НовыйТаблицаНоменклатурыПоШтрихкоду()
	...
	ТаблицаНоменклатуры.Колонки.Добавить("МолочнаяПродукцияПодконтрольнаяВЕТИС", Новый ОписаниеТипов(ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(Тип("Булево"))));
	ТаблицаНоменклатуры.Колонки.Добавить("МолочнаяПродукцияБезВЕТИС", Новый ОписаниеТипов(ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(Тип("Булево"))));
	ТаблицаНоменклатуры.Колонки.Добавить("Шины",                      Новый ОписаниеТипов(ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(Тип("Булево"))));
	ТаблицаНоменклатуры.Колонки.Добавить("АльтернативныйТабак",       Новый ОписаниеТипов(ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(Тип("Булево"))));
	ТаблицаНоменклатуры.Колонки.Добавить("УпакованнаяВода",           Новый ОписаниеТипов(ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(Тип("Булево"))));
