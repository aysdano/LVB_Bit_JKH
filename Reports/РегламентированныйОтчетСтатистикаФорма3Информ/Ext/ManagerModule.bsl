...
Функция ДеревоФормИФорматов() Экспорт
	...
	Форма20200101 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "604018", '20200730', "424", "ФормаОтчета2020Кв1");
	ВерсияВыгрузки = РегламентированнаяОтчетность.ПолучитьВерсиюВыгрузкиСтатОтчета("РегламентированныйОтчетСтатистикаФорма3Информ", "ФормаОтчета2020Кв1");
