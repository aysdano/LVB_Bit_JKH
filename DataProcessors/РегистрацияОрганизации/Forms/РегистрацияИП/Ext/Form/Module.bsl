...
Процедура КонтактнаяИнформацияРасширеннаяПодсказкаОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	Если Найти(НавигационнаяСсылкаФорматированнойСтроки, "ОбразецЗаявленияОРегистрацииИП") > 0 Тогда
		
		СтандартнаяОбработка = Ложь;
		ОткрытьФорму("Обработка.РегистрацияОрганизации.Форма.ОбразецЗаявленияОРегистрации",
			Новый Структура("Макет", НавигационнаяСсылкаФорматированнойСтроки),
			ЭтотОбъект);
...
Процедура УправлениеФормой(Форма)
	...
	Если ЭтоФорма2014(Форма.ВыбраннаяФорма) Тогда
		Элементы.ГруппаКонтактнаяИнформацияПолеEmailОрганизации.Видимость = Истина;
		Элементы.ГруппаСпособПолученияДокументов.Видимость = Ложь;
	Иначе
		Элементы.ГруппаКонтактнаяИнформацияПолеEmailОрганизации.Видимость = Ложь;
...
Функция ФормаЗаявленияПоУмолчанию(Период)
	...
	Возврат Обработки.РегистрацияОрганизации.ФормаЗаявленияПоУмолчанию(
		Период,
		"РегламентированноеУведомлениеФормаР21001");
