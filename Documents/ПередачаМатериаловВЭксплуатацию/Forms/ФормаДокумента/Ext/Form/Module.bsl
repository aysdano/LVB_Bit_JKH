...
Процедура УправлениеФормой(Форма)
	...
	Элементы.СпецодеждаНазначениеИспользования.Видимость    = Форма.ДоступнаАмортизацияСпецодежды;
	Элементы.СпецоснасткаНазначениеИспользования.Видимость  = Форма.ДоступнаАмортизацияСпецодежды;
