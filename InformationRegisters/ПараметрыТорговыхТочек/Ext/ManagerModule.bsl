...
Процедура ОбновитьСтавкиПоСпискуТорговыхТочек(ПараметрыТорговыхТочек, НаДату)
	...
	Для Каждого ПараметрыТорговойТочки Из ПараметрыТорговыхТочек Цикл
		...
		НоваяЗаписьПараметрыТорговойТочки = НаборЗаписейПараметрыТорговойТочки.Добавить();
		...
		Если НЕ ЗаписиИдентичны(НоваяЗаписьПараметрыТорговойТочки, ИсходныеПараметрыТорговойТочки) Тогда
...
Процедура ОбновитьСтавкиТорговогоСбора() Экспорт
	...
	ОбновитьСтавкиПоСпискуТорговыхТочек(ПараметрыТорговыхТочек, ДатаПроверкиСтавки);
	
КонецПроцедуры

Процедура ОбновитьСтавкиТорговыеАвтоматы() Экспорт

	ИзменитьВидТорговойДеятельностиТорговыеАвтоматы();
...
Процедура ИзменитьВидТорговойДеятельностиТорговыеАвтоматы() 
	Запрос = Новый Запрос;
