...
Процедура ОбновитьНалог()
	...
	ПредставлениеДоступныхНалогов
		= ПредставлениеДоступныхНалогов(ПрименяетсяУСНДоходы, ПрименяетсяПСН, ПлательщикЕНВД, УменьшениеЕНВДПослеОтмены);
...
Функция ПредставлениеДоступныхНалогов(УСН, ПСН, ЕНВД, ВычетЕНВДПослеОтмены)
