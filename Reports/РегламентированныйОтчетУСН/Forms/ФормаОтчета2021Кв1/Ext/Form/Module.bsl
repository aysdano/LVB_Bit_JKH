...
Процедура ПроверкаКС_1_26а()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		...
		НСтр("ru='Раздела 2.1.1 = 1 или стр.101 Раздела 2.1.1 = 2 и стр.122 Раздела 2.1.1 = стр.121 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru='%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru='Ошибочная сумма налога'"));
	Настройки = ОбработатьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_27а()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		...
		НСтр("ru='Раздела 2.1.1 = 1 или стр.101 Раздела 2.1.1 = 2 и стр.123 Раздела 2.1.1 = стр.122 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru='%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru='Ошибочная сумма налога'"));
	Настройки = ОбработатьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_27б_код(Настройки)
	...
	РасчетнаяСумма = Окр(Показатели.Р21С002.Значение + (Показатели.Р21С003.Значение - Показатели.Р21С004.Значение) * 
		Показатели.Р21С005.Значение / 100);
...
Процедура ПроверкаКС_1_31_3а()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		...
		НСтр("ru='101 Раздела 2.1.1 = 1 или стр.101 Раздела 2.1.1 = 2 и стр.122 Раздела 2.1.1 = стр.121 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru='%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru='Ошибочная сумма налога'"));
	Настройки = ОбработатьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_31_4а()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		...
		НСтр("ru='101 Раздела 2.1.1 = 1 или стр.101 Раздела 2.1.1 = 2 и стр.123 Раздела 2.1.1 = стр.122 Раздела 2.1.1'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru='%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru='Ошибочная сумма налога'"));
	Настройки = ОбработатьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_31_4б_код(Настройки)
	...
	РасчетнаяСумма = Окр(Показатели.Р22С002.Значение + (Показатели.Р22С003.Значение - Показатели.Р22С004.Значение) * 
		Показатели.Р21С005.Значение / 100);
	УсловиеВыполнено = Показатели.Р21С006.Значение = "2" И Показатели.Р21С005.Значение > Показатели.Р21С007.Значение;
	Настройки.ЭтоОшибка = УсловиеВыполнено И НЕ Показатели.Р22С001.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки, 
...
Процедура ПроверкаКС_1_42а()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		...
		НСтр("ru='Раздела 2.2 = 1 или стр.201 Раздела 2.2 = 2 и стр.262 Раздела 2.2 = стр.261 Раздела 2.2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru='%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru='Ошибочная сумма налога'"));
	Настройки = ОбработатьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_43а()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		...
		НСтр("ru='Раздела 2.2 = 1 или стр.201 Раздела 2.2 = 2 и стр.263 Раздела 2.2 = стр.262 Раздела 2.2'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, 
		НСтр("ru='%1 = %2 х %3 / 100 Итог [%4], когда %5 = 1, или %5 = 2 и %3 = %6'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru='Ошибочная сумма налога'"));
	Настройки = ОбработатьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_43б_код(Настройки)
	...
	РасчетнаяСумма = Окр(Показатели.Р23С002.Значение + (Показатели.Р23С003.Значение - Показатели.Р23С004.Значение) * 
		Показатели.Р23С005.Значение / 100);
...
Процедура Расчет(Форма, ИмяРаздела = "", ОбластьИмя = "")
	...
	ИначеЕсли ИмяРаздела = "Раздел21" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
				...
				ИначеЕсли ПризнакСтавки = "2" И ТДО["П002110012103"].Значение > ТДО["П002110012003"].Значение Тогда
					ТДО["П002110013103"].Значение = ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002110013003"].Значение)
					+ (ОкрЧФ(Форма, ТДО["П002110011103"].Значение) - ОкрЧФ(Форма, ТДО["П002110011003"].Значение))
					* ТДО["П002110012103"].Значение / 100);
				Иначе
			...
			Иначе
				...
				ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П002110012103"] > ДанРазд["П002110012003"] Тогда
					ДанРазд.Вставить("П002110013103", ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П002110013003"])
					+ (ОкрЧФ(Форма, ДанРазд["П002110011103"]) - ОкрЧФ(Форма, ДанРазд["П002110011003"]))
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
				Если ПризнакСтавки = "1"
					ИЛИ (ПризнакСтавки = "2" И ТДО["П002110012203"].Значение = ТДО["П002110012103"].Значение) Тогда
					ТДО["П002110013203"].Значение
				...
				ИначеЕсли ПризнакСтавки = "2" И ТДО["П002110012203"].Значение > ТДО["П002110012103"].Значение Тогда
					ТДО["П002110013203"].Значение = ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002110013103"].Значение)
					+ (ОкрЧФ(Форма, ТДО["П002110011203"].Значение) - ОкрЧФ(Форма, ТДО["П002110011103"].Значение))
					* ТДО["П002110012203"].Значение / 100);
				Иначе
			...
			Иначе
				...
				ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П002110012203"] > ДанРазд["П002110012103"] Тогда
					ДанРазд.Вставить("П002110013203", ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П002110013103"])
					+ (ОкрЧФ(Форма, ДанРазд["П002110011203"]) - ОкрЧФ(Форма, ДанРазд["П002110011103"]))
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
				Если ПризнакСтавки = "1"
					ИЛИ (ПризнакСтавки = "2" И ТДО["П002110012303"].Значение = ТДО["П002110012203"].Значение) Тогда
					ТДО["П002110013303"].Значение
				...
				ИначеЕсли ПризнакСтавки = "2" И ТДО["П002110012303"].Значение > ТДО["П002110012203"].Значение Тогда
					ТДО["П002110013303"].Значение = ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002110013203"].Значение)
					+ (ОкрЧФ(Форма, ТДО["П002110011303"].Значение) - ОкрЧФ(Форма, ТДО["П002110011203"].Значение))
					* ТДО["П002110012303"].Значение / 100);
				Иначе
			...
			Иначе
				...
				ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П002110012303"] > ДанРазд["П002110012203"] Тогда
					ДанРазд.Вставить("П002110013303", ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П002110013203"])
					+ (ОкрЧФ(Форма, ДанРазд["П002110011303"]) - ОкрЧФ(Форма, ДанРазд["П002110011203"]))
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
				Если ПризнакСтавки = "1"
					ИЛИ (ПризнакСтавки = "2" И ТДО["П002110012103"].Значение = ТДО["П002110012003"].Значение) Тогда
					ТДО["П002120013103"].Значение
					= ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002120011103"].Значение) * ТДО["П002110012103"].Значение / 100);
				ИначеЕсли ПризнакСтавки = "2" И ТДО["П002110012103"].Значение > ТДО["П002110012003"].Значение Тогда
					ТДО["П002120013103"].Значение = ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002120013003"].Значение)
					+ (ОкрЧФ(Форма, ТДО["П002120011103"].Значение) - ОкрЧФ(Форма, ТДО["П002120011003"].Значение))
					* ТДО["П002110012103"].Значение / 100);
				Иначе
			...
			Иначе
				...
				ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П002110012103"] > ДанРазд["П002110012003"] Тогда
					ДанРазд.Вставить("П002120013103", ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П002120013003"])
					+ (ОкрЧФ(Форма, ДанРазд["П002120011103"]) - ОкрЧФ(Форма, ДанРазд["П002120011003"]))
					* ДанРазд["П002110012103"] / 100));
				Иначе
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
				Если ПризнакСтавки = "1"
					ИЛИ (ПризнакСтавки = "2" И ТДО["П002110012203"].Значение = ТДО["П002110012103"].Значение) Тогда
					ТДО["П002120013203"].Значение
					= ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002120011203"].Значение) * ТДО["П002110012203"].Значение / 100);
				ИначеЕсли ПризнакСтавки = "2" И ТДО["П002110012203"].Значение > ТДО["П002110012103"].Значение Тогда
					ТДО["П002120013203"].Значение = ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002120013103"].Значение)
					+ (ОкрЧФ(Форма, ТДО["П002120011203"].Значение) - ОкрЧФ(Форма, ТДО["П002120011103"].Значение))
					* ТДО["П002110012203"].Значение / 100);
				Иначе
			...
			Иначе
				...
				ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П002110012203"] > ДанРазд["П002110012103"] Тогда
					ДанРазд.Вставить("П002120013203", ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П002120013103"])
					+ (ОкрЧФ(Форма, ДанРазд["П002120011203"]) - ОкрЧФ(Форма, ДанРазд["П002120011103"]))
					* ДанРазд["П002110012203"] / 100));
				Иначе
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
				Если ПризнакСтавки = "1"
					ИЛИ (ПризнакСтавки = "2" И ТДО["П002110012303"].Значение = ТДО["П002110012203"].Значение) Тогда
					ТДО["П002120013303"].Значение
					= ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002120011303"].Значение) * ТДО["П002110012303"].Значение / 100);
				ИначеЕсли ПризнакСтавки = "2" И ТДО["П002110012303"].Значение > ТДО["П002110012203"].Значение Тогда
					ТДО["П002120013303"].Значение = ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П002120013203"].Значение)
					+ (ОкрЧФ(Форма, ТДО["П002120011303"].Значение) - ОкрЧФ(Форма, ТДО["П002120011203"].Значение))
					* ТДО["П002110012303"].Значение / 100);
				Иначе
			...
			Иначе
				...
				ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П002110012303"] > ДанРазд["П002110012203"] Тогда
					ДанРазд.Вставить("П002120013303", ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П002120013203"])
					+ (ОкрЧФ(Форма, ДанРазд["П002120011303"]) - ОкрЧФ(Форма, ДанРазд["П002120011203"]))
					* ДанРазд["П002110012303"] / 100));
				Иначе
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
				ТДО["П002120016003"].Значение = Мин(ОкрЧФ(Форма, ТДО["П002110013003"].Значение)
				- ОкрЧФ(Форма, ТДО["П002110014003"].Значение), Мин(ОкрЧФ(Форма, ТДО["П002120013003"].Значение)
				- ОкрЧФ(Форма, ТДО["П002120014003"].Значение), ОкрЧФ(Форма, ТДО["П002120015003"].Значение)));
			Иначе
				ДанРазд.Вставить("П002120016003", Мин(ОкрЧФ(Форма, ДанРазд["П002110013003"])
				- ОкрЧФ(Форма, ДанРазд["П002110014003"]), Мин(ОкрЧФ(Форма, ДанРазд["П002120013003"])
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
				ТДО["П002120016103"].Значение = Мин(ОкрЧФ(Форма, ТДО["П002110013103"].Значение)
				- ОкрЧФ(Форма, ТДО["П002110014103"].Значение), Мин(ОкрЧФ(Форма, ТДО["П002120013103"].Значение)
				- ОкрЧФ(Форма, ТДО["П002120014103"].Значение), ОкрЧФ(Форма, ТДО["П002120015103"].Значение)));
			Иначе
				ДанРазд.Вставить("П002120016103", Мин(ОкрЧФ(Форма, ДанРазд["П002110013103"])
				- ОкрЧФ(Форма, ДанРазд["П002110014103"]), Мин(ОкрЧФ(Форма, ДанРазд["П002120013103"])
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
				ТДО["П002120016203"].Значение = Мин(ОкрЧФ(Форма, ТДО["П002110013203"].Значение)
				- ОкрЧФ(Форма, ТДО["П002110014203"].Значение), Мин(ОкрЧФ(Форма, ТДО["П002120013203"].Значение)
				- ОкрЧФ(Форма, ТДО["П002120014203"].Значение), ОкрЧФ(Форма, ТДО["П002120015203"].Значение)));
			Иначе
				ДанРазд.Вставить("П002120016203", Мин(ОкрЧФ(Форма, ДанРазд["П002110013203"])
				- ОкрЧФ(Форма, ДанРазд["П002110014203"]), Мин(ОкрЧФ(Форма, ДанРазд["П002120013203"])
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
				ТДО["П002120016303"].Значение = Мин(ОкрЧФ(Форма, ТДО["П002110013303"].Значение)
				- ОкрЧФ(Форма, ТДО["П002110014303"].Значение), Мин(ОкрЧФ(Форма, ТДО["П002120013303"].Значение)
				- ОкрЧФ(Форма, ТДО["П002120014303"].Значение), ОкрЧФ(Форма, ТДО["П002120015303"].Значение)));
			Иначе
				ДанРазд.Вставить("П002120016303", Мин(ОкрЧФ(Форма, ДанРазд["П002110013303"])
				- ОкрЧФ(Форма, ДанРазд["П002110014303"]), Мин(ОкрЧФ(Форма, ДанРазд["П002120013303"])
	...
	ИначеЕсли ИмяРаздела = "Раздел22" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел22" Тогда
				...
				ИначеЕсли ПризнакСтавки = "2" И ТДО["П000220026103"].Значение > ТДО["П000220026003"].Значение Тогда
					ТДО["П000220027103"].Значение = ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П000220027003"].Значение)
					+ (ОкрЧФ(Форма, ТДО["П000220024103"].Значение) - ОкрЧФ(Форма, ТДО["П000220024003"].Значение))
					* ТДО["П000220026103"].Значение / 100);
				Иначе
			...
			Иначе
				...
				ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П000220026103"] > ДанРазд["П000220026003"] Тогда
					ДанРазд.Вставить("П000220027103", ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П000220027003"])
					+ (ОкрЧФ(Форма, ДанРазд["П000220024103"]) - ОкрЧФ(Форма, ДанРазд["П000220024003"]))
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел22" Тогда
				Если ПризнакСтавки = "1"
					ИЛИ (ПризнакСтавки = "2" И ТДО["П000220026203"].Значение = ТДО["П000220026103"].Значение) Тогда
					ТДО["П000220027203"].Значение
				...
				ИначеЕсли ПризнакСтавки = "2" И ТДО["П000220026203"].Значение > ТДО["П000220026103"].Значение Тогда
					ТДО["П000220027203"].Значение = ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П000220027103"].Значение)
					+ (ОкрЧФ(Форма, ТДО["П000220024203"].Значение) - ОкрЧФ(Форма, ТДО["П000220024103"].Значение))
					* ТДО["П000220026203"].Значение / 100);
				Иначе
			...
			Иначе
				...
				ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П000220026203"] > ДанРазд["П000220026103"] Тогда
					ДанРазд.Вставить("П000220027203", ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П000220027103"])
					+ (ОкрЧФ(Форма, ДанРазд["П000220024203"]) - ОкрЧФ(Форма, ДанРазд["П000220024103"]))
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел22" Тогда
				Если ПризнакСтавки = "1"
					ИЛИ (ПризнакСтавки = "2" И ТДО["П000220026303"].Значение = ТДО["П000220026203"].Значение) Тогда
					ТДО["П000220027303"].Значение
				...
				ИначеЕсли ПризнакСтавки = "2" И ТДО["П000220026303"].Значение > ТДО["П000220026203"].Значение Тогда
					ТДО["П000220027303"].Значение = ОкрЧФ(Форма, ОкрЧФ(Форма, ТДО["П000220027203"].Значение)
					+ (ОкрЧФ(Форма, ТДО["П000220024303"].Значение) - ОкрЧФ(Форма, ТДО["П000220024203"].Значение))
					* ТДО["П000220026303"].Значение / 100);
				Иначе
			...
			Иначе
				...
				ИначеЕсли ПризнакСтавки = "2" И ДанРазд["П000220026303"] > ДанРазд["П000220026203"] Тогда
					ДанРазд.Вставить("П000220027303", ОкрЧФ(Форма, ОкрЧФ(Форма, ДанРазд["П000220027203"])
					+ (ОкрЧФ(Форма, ДанРазд["П000220024303"]) - ОкрЧФ(Форма, ДанРазд["П000220024203"]))
...
Процедура ПроверитьЗаполнение_Раздел21(СтатусПроверки)
	...
	Окр_П002120016003 = ОкрЧФ(ЭтаФорма, ДанныеРаздела.П002120016003);
	Окр_П002110013003 = ОкрЧФ(ЭтаФорма, ДанныеРаздела.П002110013003);
	Окр_П002110014003 = ОкрЧФ(ЭтаФорма, ДанныеРаздела.П002110014003);
	...
	Окр_П002120016103 = ОкрЧФ(ЭтаФорма, ДанныеРаздела.П002120016103);
	Окр_П002110013103 = ОкрЧФ(ЭтаФорма, ДанныеРаздела.П002110013103);
	Окр_П002110014103 = ОкрЧФ(ЭтаФорма, ДанныеРаздела.П002110014103);
	...
	Окр_П002120016203 = ОкрЧФ(ЭтаФорма, ДанныеРаздела.П002120016203);
	Окр_П002110013203 = ОкрЧФ(ЭтаФорма, ДанныеРаздела.П002110013203);
	Окр_П002110014203 = ОкрЧФ(ЭтаФорма, ДанныеРаздела.П002110014203);
	...
	Окр_П002120016303 = ОкрЧФ(ЭтаФорма, ДанныеРаздела.П002120016303);
	Окр_П002110013303 = ОкрЧФ(ЭтаФорма, ДанныеРаздела.П002110013303);
	Окр_П002110014303 = ОкрЧФ(ЭтаФорма, ДанныеРаздела.П002110014303);
