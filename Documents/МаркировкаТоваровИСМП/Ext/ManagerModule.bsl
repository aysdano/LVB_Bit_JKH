...
#Область ПолучениеДанныхДокумента
	...
	|	ЕСТЬNULL(Товары.ИдентификаторПроисхожденияВЕТИС.Идентификатор, """") КАК ИдентификаторПроисхожденияВЕТИССтрокой,
...
Процедура СообщитьВерсияОбменаУстарела(СообщениеJSON, Шапка)
	ИнтеграцияИСКлиентСервер.ДобавитьТекстОшибки(
		СообщениеJSON,
