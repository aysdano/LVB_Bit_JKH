...
Процедура УправлениеФормойСервер()
	...
	ВыполнятьРасчетНДФЛПоПрогрессивнойШкале   = УчетЗарплаты.ВыполнятьРасчетНДФЛПоПрогрессивнойШкале(Объект.Организация, Объект.Дата);
	...
	Элементы.РасчетыПоЗаработнойПлатеНДФЛСПревышения.Видимость      = ВыполнятьРасчетНДФЛПоПрогрессивнойШкале;
