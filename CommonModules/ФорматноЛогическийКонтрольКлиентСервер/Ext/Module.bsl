				...
				Для ИндексМассива = 0 По ГраницаНачальногоМассива Цикл
					...
					Если ТекущаяПозиция.Свойство("ФискальнаяСтрока") Тогда
						...
						Если Количество = 1 Тогда
							...
							// БИТ ЖКХ 03.02.2021
							НоваяПозиция.СуммаНДС = УчетНДСКлиентСервер.РассчитатьСуммуНДС(НоваяПозиция.Сумма, Истина, 
								УчетНДСВызовСервераПовтИсп.ПолучитьСтавкуНДС(НоваяПозиция.СтавкаНДС));
							//-БИТ ЖКХ 03.02.2021
