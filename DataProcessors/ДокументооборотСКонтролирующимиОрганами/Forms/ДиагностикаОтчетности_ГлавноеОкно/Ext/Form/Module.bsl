...
Процедура НачатьПроверку(Команда, АвтонастройкаВыполнена = Ложь) //0
	...
	РезультатыДиагностики.Отчет.Вставить("ВерсияПрограммы", бит_ОбщегоНазначенияПовтИсп.ПолучитьНомерРелиза_1С());
	...
	РезультатыДиагностики.Отчет.ДополнительнаяИнформация.Вставить("бит_ОбщегоНазначенияПовтИсп.ПолучитьНомерРелиза_1С()", бит_ОбщегоНазначенияПовтИсп.ПолучитьНомерРелиза_1С());
...
Функция ПолучитьРеквизитыМетаданных()
	...
	Возврат Новый Структура("Версия, Синоним, УровниЖР", бит_ОбщегоНазначенияПовтИсп.ПолучитьНомерРелиза_1С(), Метаданные.Синоним, Уровни.Количество());
