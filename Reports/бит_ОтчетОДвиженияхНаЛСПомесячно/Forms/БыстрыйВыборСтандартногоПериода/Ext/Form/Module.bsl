...
//
&НаКлиенте
Процедура НачалоВыбораИзСпискаПредставленияПериодаРегистрации(Элемент, СтандартнаяОбработка, НачалоПериода, ЭтаФорма, ПредставлениеПериодаРегистрации, КонецПериода = Неопределено, НачальноеЗначение = Неопределено, Период = "ГОД")
...
Процедура СтандартныйПериод(Команда)
	...
	ДиалогРедактирования.Показать(Новый ОписаниеОповещения("СтандартныйПериодЗавершение", ЭтотОбъект, Новый Структура("ДиалогРедактирования", ДиалогРедактирования)));
...
&НаКлиенте
Процедура СтандартныйПериодЗавершение(Период, ДополнительныеПараметры) Экспорт
    
    ДиалогРедактирования = ДополнительныеПараметры.ДиалогРедактирования;
...
&НаКлиенте
Функция ПолучитьПредставлениеПериодаРегистрации(НачалоПериода, КонецПериода = Неопределено, Период = "ГОД")
...
&НаКлиенте
Процедура РегулированиеПредставленияПериодаРегистрации(Направление, СтандартнаяОбработка, НачалоПериода, ПредставлениеПериодаРегистрации, КонецПериода = Неопределено, Период = "ГОД")
