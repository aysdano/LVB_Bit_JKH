...
Процедура СостояниеКонтрагентаПоДаннымЕГРН(ИнформацияОСвязях, Контрагент) Экспорт
	ПолучитьСостояниеКонтрагентаПоДаннымЕГРН(ИнформацияОСвязях, Контрагент);
КонецПроцедуры

Процедура ДанныеБухгалтерскойОтчетности(ИнформацияОСвязях, СтруктураГодов) Экспорт
	ПодготовитьДанныеБухгалтерскойОтчетности(ИнформацияОСвязях, СтруктураГодов);
КонецПроцедуры

Функция ПериодыБухгалтерскойОтчетности(ИнформацияОСвязях) Экспорт
