...
Функция ДеревоФормИФорматов() Экспорт
	...
	Форма20210101 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "611012", '20200721', "399", "ФормаОтчета2021Кв1");
	ВерсияВыгрузки = РегламентированнаяОтчетность.ПолучитьВерсиюВыгрузкиСтатОтчета("РегламентированныйОтчетСтатистикаФормаП1СХ", "ФормаОтчета2021Кв1");
