...
Процедура Подключаемый_НачатьПолучениеСертификата()
	...
	ХранилищаСертификатов = Новый Массив;
		
	ХранилищеСертификатов = Новый Структура;
	ХранилищеСертификатов.Вставить("Хранилище", "MY");
	ХранилищеСертификатов.Вставить("ЭтоЛокальноеХранилище", Истина);
	
	ХранилищаСертификатов.Добавить(ХранилищеСертификатов);
	
	ХранилищеСертификатов = Новый Структура;
	ХранилищеСертификатов.Вставить("Хранилище", "MY");
	ХранилищеСертификатов.Вставить("ЭтоЛокальноеХранилище", Ложь);
	
	ХранилищаСертификатов.Добавить(ХранилищеСертификатов);
	
	КриптографияЭДКОКлиент.ПолучитьСертификаты(ОписаниеОповещения, ХранилищаСертификатов, ДополнительныеПараметрыМетода);
