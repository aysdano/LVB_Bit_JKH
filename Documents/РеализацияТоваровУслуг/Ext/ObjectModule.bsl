...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	// БИТ_ЖКХ 25.12.2019{{	
	// БИТ_ЖКХ 23.10.2017 11:01:18 Начало правки...
	//// БИТ_ЖКХ 31.03.2015{{
    //Если бит_ДокументОснование = Неопределено Тогда 
	Если НЕ ЗначениеЗаполнено(бит_Здание) Тогда 
	//// БИТ_ЖКХ 31.03.2015}}	
	// БИТ_ЖКХ 23.10.2017 11:01:
	...
	// БИТ_ЖКХ 15.10.2020 -- код БИТ от 25.12.2019	
	//УчетДоходовРасходов.СформироватьДвиженияРеализация(
	//	ТаблицаСобственныеТоварыУслуги, ТаблицаТоварыУслугиКомитентов, ТаблицаРеализованныеТоварыКомитентов,
	//	ПараметрыПроведения.Реквизиты, Движения, Отказ);
	// БИТ_ЖКХ 26.03.2021
