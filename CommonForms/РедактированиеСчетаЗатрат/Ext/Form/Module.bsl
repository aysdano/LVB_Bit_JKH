...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если КлючНазначенияИспользования = "РасходМатериалов" Тогда
		Элементы.ГруппаРасположениеСчетовУчета.Видимость = ФормаОткрытаИзШапки;
...
Процедура РасположениеСчетовЗатратПриИзменении(Элемент)
	...
	Элементы.ГруппаСчетаУчета.Видимость = Не (ФормаОткрытаИзШапки И СчетаУчетаЗатратВТаблице);
...
Процедура УстановитьПереключательРасположенияСчетовЗатрат(Форма)
	...
	Элементы.ГруппаСчетаУчета.Видимость = Не (Форма.ФормаОткрытаИзШапки И Форма.СчетаУчетаЗатратВТаблице);
