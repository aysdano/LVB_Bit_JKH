...
Функция ОписаниеЧтоТакоеИндексФинансовогоРиска()
	...
	Возврат СтроковыеФункции.ФорматированнаяСтрока(
		НСтр("ru = '<b>Индекс финансового риска</b> - это вероятностная оценка несостоятельности компании.
			|
			|" + ОписаниеИндекса + "
			|  <span style=""color: ЦветГрадацияСПАРКНизкийРиск"">0 - 14 - низкий риск;</span>
			|  <span style=""color: ЦветГрадацияСПАРКСреднийРиск"">15 - 85  - средний риск;</span>
			|  <span style=""color: ЦветГрадацияСПАРКВысокийРиск"">86 - 100 - высокий риск.</span>'"));
