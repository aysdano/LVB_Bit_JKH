...
Процедура ПодготовитьОформлениеФормы()
	...
	Если Режим = 1 Тогда
		...
		КонецЕсли;	
		Описание = НСтр("ru = 'Обновление ФНС, ПФР и Росстат производится по организации, пользователем 1С-Отчетности которой Вы являетесь.'")
					+ Символы.ПС
	...
	ИначеЕсли Режим = 2 Тогда				
		...
		КонецЕсли;	
		Описание = НСтр("ru = 'Обновление ФНС, ПФР и Росстат производится по организации, пользователем 1С-Отчетности которых Вы являетесь.'");
		
	ИначеЕсли Режим = 3 Тогда
		ТекстЗаголовока = НСтр("ru = 'Нет организаций для обновления'");
		Описание = НСтр("ru = 'Вы не являетесь пользователем 1С-Отчетности ни по одной организации для обновления ФНС, ПФР или Росста.'")
					+ Символы.ПС
