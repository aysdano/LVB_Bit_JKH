...
Процедура ЗаполнитьКодыДоходов2018()
	...
	ОписатьКодДоходаНДФЛ( , Ставка13, "2611", "Суммы прекращенных обязательств по уплате задолженности в связи с признанием такой задолженности в установленном порядке безнадежной к взысканию");
...
Процедура ЗаполнитьКодыДоходов2021() Экспорт
	...
	// АПК:1297-выкл Не локализуется, т.к. является частью регламентированной формы, применяемой в РФ.
	// АПК:1036-выкл 
	ОписатьКодДоходаНДФЛ(, Ставка13, "1401", "Доходы, полученные от сдачи в аренду или иного использования жилого недвижимого имущества");
	ОписатьКодДоходаНДФЛ(, Ставка13, "1402", "Доходы, полученные от сдачи в аренду или иного использования имущества, за исключением доходов с кодом 1401");
	ОписатьКодДоходаНДФЛ("Код1500", Ставка13, "1500", "Доходы по договорам купли-продажи (мены) ценных бумаг, налогообложение которых производится в соответствии с абзацем третьим пункта 1 статьи 226 НК РФ");
	ОписатьКодДоходаНДФЛ("Код2004", Ставка13, "2004", "Суммы выплат ежемесячного денежного вознаграждения за классное руководство педагогическим работникам за счет средств федерального бюджета",,,,, Истина);
	ОписатьКодДоходаНДФЛ(, Ставка13, "2017", "Суточные, превышающие 700 рублей за каждый день в командировке на территории РФ и не более 2 500 рублей за каждый день в командировке за пределами РФ");
	ОписатьКодДоходаНДФЛ(, Ставка13, "2611", "Суммы прекращенных обязательств по уплате задолженности в связи с признанием такой задолженности в установленном порядке безнадежной к взысканию");
	ОписатьКодДоходаНДФЛ("Код2763",	Ставка13, "2763", "Материальная помощь, оказываемая образовательной организацией студентам (курсантам), аспирантам, адъюнктам, ординаторам и ассистентам-стажерам", Истина, Истина, Справочники.ВидыВычетовНДФЛ.Код511, , , "2763");
	ОписатьКодДоходаНДФЛ(, Ставка13, "3010", "Доходы в виде выигрышей, полученных от участия в азартных играх, проводимых в букмекерской конторе и тотализаторе");
	ОписатьКодДоходаНДФЛ("Код3011", Ставка13, "3011", "Доходы в виде выигрышей, полученных от участия в лотерее");
	// АПК:1297-вкл
	// АПК:1036-вкл 
