...
Функция ДеревоФормИФорматов() Экспорт
	...
	Форма20200101 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "609506", '20200730', "424", "ФормаОтчета2020Кв1");
	ВерсияВыгрузки = РегламентированнаяОтчетность.ПолучитьВерсиюВыгрузкиСтатОтчета("РегламентированныйОтчетСтатистикаФорма85К", "ФормаОтчета2020Кв1");
