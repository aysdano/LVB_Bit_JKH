...
Процедура ДополнитьПараметрыВыгрузки(ПараметрыВыгрузки)
	...
	ПараметрыВыгрузки.Вставить("П000000010199_10", "Наличие нарушенных земель на 31.12.20__ - всего");
	...
	ПараметрыВыгрузки.Вставить("П000000010199_3", "За отчетный 20__г. Нарушено земель - всего");
	ПараметрыВыгрузки.Вставить("П000000010199_2", "в том числе отработано");
	ПараметрыВыгрузки.Вставить("П000000010199_1", "Наличие нарушенных земель на 01.01.20__ всего");
КонецПроцедуры
