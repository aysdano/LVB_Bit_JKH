...
Процедура УстановитьДоступностьОбластей(Форма, ИмяРаздела)
	...
	ИначеЕсли ИмяРаздела = "Раздел21" Тогда
		...
		КодыВидаПТ_ДоступностьСтавкиВидаПТ.Добавить("410");
		КодыВидаПТ_ДоступностьСтавкиВидаПТ.Добавить("412");
		КодыВидаПТ_ДоступностьСтавкиВидаПТ.Добавить("413");
		КодыВидаПТ_ДоступностьСтавкиВидаПТ.Добавить("414");
		КодыВидаПТ_ДоступностьСтавкиВидаПТ.Добавить("415");
		КодыВидаПТ_ДоступностьСтавкиВидаПТ.Добавить("420");
		КодыВидаПТ_ДоступностьСтавкиВидаПТ.Добавить("430");
		КодыВидаПТ_ДоступностьСтавкиВидаПТ.Добавить("440");
		КодыВидаПТ_ДоступностьСтавкиВидаПТ.Добавить("441");
		КодыВидаПТ_ДоступностьСтавкиВидаПТ.Добавить("442");
		...
		КодыВидаПТ_ДоступностьСтавкиВидаПТ.Добавить("473");
		...
		КодыВидаПТ_НедоступностьР21Гр3Р22Гр3.Добавить("410");
		КодыВидаПТ_НедоступностьР21Гр3Р22Гр3.Добавить("412");
		КодыВидаПТ_НедоступностьР21Гр3Р22Гр3.Добавить("413");
		КодыВидаПТ_НедоступностьР21Гр3Р22Гр3.Добавить("414");
		КодыВидаПТ_НедоступностьР21Гр3Р22Гр3.Добавить("415");
		КодыВидаПТ_НедоступностьР21Гр3Р22Гр3.Добавить("420");
		...
		КодыВидаПТ_НедоступностьР21Гр3Р22Гр3.Добавить("473");
