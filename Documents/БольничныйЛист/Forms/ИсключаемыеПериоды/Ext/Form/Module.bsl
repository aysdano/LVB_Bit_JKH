...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Для Каждого ИсключаемыйПериод Из ИсключаемыеПериоды Цикл
		...
		ИначеЕсли ИсключаемыйПериод.ДатаНачала < ДатаНачала Тогда
			ИсключаемыйПериод.ТекстОшибки = НСтр("ru = 'Дата начала предшествует началу нетрудоспособности (%1)'");
			ИсключаемыйПериод.ТекстОшибки = СтрШаблон(ИсключаемыйПериод.ТекстОшибки, Формат(ДатаНачала, "ДЛФ=D"));
			ИсключаемыйПериод.Ошибка = Истина;
			Отказ = Истина;
		ИначеЕсли ИсключаемыйПериод.ДатаОкончания > ДатаОкончания Тогда
			...
			ИсключаемыйПериод.ТекстОшибки = СтрШаблон(ИсключаемыйПериод.ТекстОшибки, Формат(ДатаОкончания, "ДЛФ=D"));
			ИсключаемыйПериод.Ошибка = Истина;
			Отказ = Истина;
		КонецЕсли;
