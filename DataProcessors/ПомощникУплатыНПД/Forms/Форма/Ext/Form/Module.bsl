...
Функция ДанныеЗаполненияПлатежногоДокументаВФоне(СпособОплаты)
	...
	Отбор = Новый Структура("ИдентификаторИсточника", ТаблицаЗадолженностей[0].ИдентификаторПлатежа);
	...
	ПараметрыОбработчика.Вставить("ВидОбязательства", ТаблицаЗадолженностей[0].ВидНалоговогоОбязательства);
...
#Область ЗапросНаИзменениеРазрешений
