...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	// БИТ_ЖКХ 28.07.2016 17:14:43 Начало правки...
	СписокОбъектов.Добавить(Документы.бит_Предупреждение);
	СписокОбъектов.Добавить(Документы.бит_ИсковоеЗаявление);
	СписокОбъектов.Добавить(Документы.бит_ЕдиныйЖилДокумент);
	СписокОбъектов.Добавить(Документы.бит_ЗаявлениеОРегистрацииПоМестуПЖ);
	СписокОбъектов.Добавить(Документы.бит_ЗаявлениеТСЖ);
	СписокОбъектов.Добавить(Документы.бит_СправкаОСоставеСемьи);
	СписокОбъектов.Добавить(Документы.бит_СправкиПаспортногоСтола);
	СписокОбъектов.Добавить(Документы.бит_ФормированиеПаспортаДома);
	СписокОбъектов.Добавить(Документы.бит_ИсполнительныйЛист);
	// БИТ_ЖКХ 28.07.2016 17:14:43 Конец правки. 	
