...
Функция ПоказателиРасходовСтраховыеВзносы(Организация, Патент, ДатаНачала, ДатаОкончания) Экспорт
	...
	ПоказателиРасходов.ВсегоРасходыСтраховыеВзносы =
		РегистрыНакопления.РасходыУменьшающиеНалогПоОтдельнымРежимам.РасходыПСНЗаГод(Организация, ДатаНачала);
	...
	ПоказателиРасходов.ОстатокРасходыСтраховыеВзносы = Мин(СвободныйОстатокРасходов, ОставшийсяЛимитУменьшенияНалога);
...
Функция СтатусУплаты(ПараметрыЗадачи)
	...
	ПоказателиРасходов = ПоказателиРасходовККМУменьшающихНалог(Организация,
