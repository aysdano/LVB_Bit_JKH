...
Процедура СчетПриИзменении(Элемент)
	...
	Если Счет <> ПредопределенноеЗначение("ПланСчетов.Хозрасчетный.РасходыНаОплатуТрудаБудущихПериодов") Тогда
		СчетНУ      = Неопределено;
...
Процедура ПодготовитьФормуНаСервере()
	...
	Если Параметры.Ключ.Пустая() Тогда
		Если (ПолучитьФункциональнуюОпцию("ИспользуетсяЕНВД") ИЛИ ПолучитьФункциональнуюОпцию("ИспользуетсяУСНПатент"))
			И НЕ (ПолучитьФункциональнуюОпцию("ИспользуетсяОСНО") ИЛИ ПолучитьФункциональнуюОпцию("ИспользуетсяУСН")) Тогда
...
Процедура УстановитьТекстНадписиСчетУчетаРасходовПоСтраховымВзносам(Форма)
	...
	Если ЗначениеЗаполнено(Форма.Счет) Тогда
		Если Форма.Счет = ПредопределенноеЗначение("ПланСчетов.Хозрасчетный.РасходыНаОплатуТрудаБудущихПериодов") Тогда
...
Процедура УправлениеСчетомНУ(Форма)
	...
	ЭтоРБП = Форма.Счет = ПредопределенноеЗначение("ПланСчетов.Хозрасчетный.РасходыНаОплатуТрудаБудущихПериодов");
