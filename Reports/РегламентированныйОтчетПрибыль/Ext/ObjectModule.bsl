...
Процедура ВывестиНаПечатьДанныеМногоуровневогоРаздела(ИмяФормы,
	...
	ИначеЕсли ИмяТекРаздела = "Лист04" ИЛИ ИмяТекРаздела = "Лист05" ИЛИ ИмяТекРаздела = "Лист06"
	...
	ИначеЕсли ИмяТекРаздела = "Приложение2" Тогда
		...
		Для каждого Ветка Из ДеревоДанныхРаздела.Строки Цикл
			...
			Для НомЛиста = 1 По КолЛистовРаздела Цикл
				...
				Для ИндСтрокиМнЧ = 1 По СтрокМнЧ1НаЛисте Цикл
					...
					Для НомСтрМнЧ2ВБлокеМнЧ1 = 1 По СтрокМнЧ2ВБлокеМнЧ1 Цикл
						...
						_ИндСтрМнЧ2ВБлокеМнЧ1 = РегламентированнаяОтчетностьКлиентСервер.СтрокаСИндексомПоказателя(НомСтрМнЧ2ВБлокеМнЧ1);
					...
					Если МассивДанныхМнЧ1_МнЧ2.Количество() >= ИндСПриращением Тогда
						...
						Для НомСтрМнЧ2ВБлокеМнЧ1 = 1 По СтрокМнЧ2ВБлокеМнЧ1 Цикл
							...
							_ИндСтрМнЧ2ВБлокеМнЧ1 =
								РегламентированнаяОтчетностьКлиентСервер.СтрокаСИндексомПоказателя(НомСтрМнЧ2ВБлокеМнЧ1);
			...
			Для НомЛиста = 1 По КолЛистовРаздела Цикл
				...
				Для Ном = 1 По СтрокМнЧ1НаЛисте - 1 Цикл
					ИмяОбластиПреемника = "ДобавлениеСтроки" + ИмяГруппыМнЧ1
					+ РегламентированнаяОтчетностьКлиентСервер.СтрокаСИндексомПоказателя(Ном);
					ВставитьДопСтроку(ИмяФормы,
						  		  	  СтруктураРеквизитовФормы,
						  		  	  ТабличныйДокумент,
				...
				Для Ном = 1 По СтрокМнЧ1НаЛисте Цикл
					Для ПодчНом = 1 По СтрокМнЧ2ВБлокеМнЧ1 - 1 Цикл
						ИмяОбластиПреемника
						= "ДобавлениеСтроки" + ИмяГруппыМнЧ2
						+ РегламентированнаяОтчетностьКлиентСервер.СтрокаСИндексомПоказателя(Ном)
				...
				Для Ном = 1 По СтрокМнЧ3НаЛисте - 1 Цикл
					ИмяОбластиПреемника = "ДобавлениеСтроки" + ИмяГруппыМнЧ3
					+ РегламентированнаяОтчетностьКлиентСервер.СтрокаСИндексомПоказателя(Ном);
					ВставитьДопСтроку(ИмяФормы,
						  		  	  СтруктураРеквизитовФормы,
						  		  	  ТабличныйДокумент,
...
Процедура ЗаполнитьПечатнуюФорму(ИмяФормы,
	...
	ИначеЕсли ПараметрыПечати.ИмяСтраницы = "Лист08_прод" Тогда
		МакетФормыОтчета = ЭтотОбъект.ПолучитьМакет(ИмяФормы + "_Лист08");
