...
Функция ПараметрыФормыДокумента()
	...
	Если Задание.ЛичныйВычет ИЛИ Задание.ВычетНаДетей Тогда
		...
		НаименованиеФормы = "Документ.ЗаявлениеНаПредоставлениеСтандартныхВычетовПоНДФЛ.Форма.ФормаДокумента";
	Иначе
		ЗаполнитьПараметрыЗаполненияВычет(ПараметрыЗаполнения);
		НаименованиеФормы = "Документ.УведомлениеОПравеНаИмущественныйВычетДляНДФЛ.Форма.ФормаДокумента";
	КонецЕсли;
