...
Процедура ОпределитьНомерПриказа()
	...
	Если ГодНачалаДействияПриказа <= "2020" Тогда
		ИмяМакета      = "КлассификацияДоходовБюджетов2020";
		НадписьПриказа = НСтр("ru = 'по приказу Минфина от 6 июня 2019 г. № 85н
			|(в редакции приказа Минфина от 28.09.2020 № 215н)'");
	Иначе
		ИмяМакета      = "КлассификацияДоходовБюджетов";
		НадписьПриказа = НСтр("ru = 'по приказу Минфина от 8 июня 2020 г. № 99н
			|(в редакции приказа Минфина от 07.12.2020 № 297н)'");
	КонецЕсли;
