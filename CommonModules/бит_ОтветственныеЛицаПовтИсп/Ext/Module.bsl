...
Функция ОтветственныеЛица(Организация, ДатаСреза, Подразделение = Неопределено) Экспорт
	...
	Возврат Новый ФиксированнаяСтруктура(бит_ОтветственныеЛицаПереопределяемый.ОтветственныеЛица(Организация, ДатаСреза, Подразделение));
...
Функция ДатыИзмененияОтветственныхЛицОрганизаций(Организация) Экспорт
	...
	Возврат Новый ФиксированныйМассив(бит_ОтветственныеЛицаПереопределяемый.ДатыИзмененияОтветственныхЛицОрганизаций(Организация));
