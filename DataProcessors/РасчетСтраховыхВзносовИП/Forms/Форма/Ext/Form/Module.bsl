...
Процедура УправлениеФормойНаСервере()
	...
	Элементы.ГруппаСверка.Видимость = Используется1СОтчетность И Не ВыполняетсяАктуализацияРасчета;
	Элементы.ГруппаНастройкиСтраховыхВзносов.Видимость = Не ВыполняетсяАктуализацияРасчета;
...
Процедура Подключаемый_АктуализироватьРасчетВзносов()
	...
	ИдентификаторЗаданияАктуализацииРасчета = ДлительнаяОперация.ИдентификаторЗадания;
...
Процедура ОбработатьРезультатАктуализацииРасчетаВзносов(Результат, ДополнительныеПараметры) Экспорт
	...
	ИдентификаторЗаданияАктуализацииРасчета = Неопределено;
