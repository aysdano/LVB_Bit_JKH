		...
		Иначе
			...
			Если Не РезультатПолученияДанных.ЕстьОшибки
				...
				Если ПрерватьОбработкуЗагрузкиДанных(
					...
					ТребуетсяПрерватьОбработкуЗагрузкиДанных) Тогда
	...
	Попытка
		...
		Если Не Параметры.ПроверкаНеПоДокументу Тогда
			...
			Если Параметры.СоздаватьАктОРасхождениях Тогда
				...
				ЗначенияШтрихкодовЭДО = ШтрихкодированиеИСМПСлужебный.ДанныеМаркируемойНоменклатурыКодовМаркировкиПоДаннымЭДО(Параметры.ПроверяемыйДокумент);
				...
				ШтрихкодыУпаковокДокументаИСМП = ЗначенияШтрихкодовЭДО.ВыгрузитьКолонку("ЗначениеШтрихкода");
				ШтрихкодыУпаковокДокументаИСМП = ОбщегоНазначенияКлиентСервер.СвернутьМассив(ШтрихкодыУпаковокДокументаИСМП);
				ДанныеШтрихкодовСписок = Новый Массив;
...
Функция ПрерватьОбработкуЗагрузкиДанных(ДанныеДокумента, ПараметрыСканирования, ДанныеНоменклатурыПоДаннымУПД, ДеревоУпаковок, ТребуетсяПрерватьОбработкуЗагрузкиДанных)
