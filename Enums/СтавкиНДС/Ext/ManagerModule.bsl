...
Функция СтавкаНДС(ВидСтавки, Период) Экспорт
	...
	//shevtsov 21/01/2026 Начало
	ИначеЕсли ВидСтавки = Перечисления.ВидыСтавокНДС.Повышенная Тогда
		Возврат Перечисления.СтавкиНДС.НДС22;
	ИначеЕсли ВидСтавки = Перечисления.ВидыСтавокНДС.ПовышеннаяРасчетная Тогда
		Возврат Перечисления.СтавкиНДС.НДС22_122;
	//shevtsov 21/01/2026 Окончание
	Иначе
