...
Процедура УстановитьФункциональныеОпцииФормы()
	...
	Если УчетЗарплатыИКадровСредствамиБухгалтерии Тогда
		...
		ВыполнятьРасчетНДФЛПоПрогрессивнойШкале = ПолучитьФункциональнуюОпцию("ВыполнятьРасчетНДФЛПоПрогрессивнойШкале",
			...
			И Объект.ПланируемаяДатаВыплаты >= УчетЗарплаты.ДатаНачалаУчетаПрогрессивногоНДФЛ();
		
	Иначе
		
		ВыполнятьРасчетНДФЛПоПрогрессивнойШкале = Объект.Дата >= УчетЗарплаты.ДатаНачалаУчетаПрогрессивногоНДФЛ();
