...
Процедура ОбновитьВидимостьДоступность()
	...
	НедоступныйЦветТекста = ЦветаСтиля.ЗакрытыйДокументБЗК;
	НедоступныйЦветРамки  = ЦветаСтиля.НедоступныеДанныеЦвет;
	...
	Если ЭтоЗарплатныйПроект Или ЭтоБанковскийСчет Тогда
		...
		Если ТолькоПросмотрНомераСчета Тогда
			...
			Элементы.НомерСчета.ЦветТекстаЗаголовка = НедоступныйЦветРамки;
		Иначе
