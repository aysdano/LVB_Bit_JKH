...
Процедура ВосстановитьВариантыАвтозаполненияПоказателейРаздела(ИмяФормы, ВариантыЗаполнения, СохраненныеВарианты) Экспорт
...
Процедура ПодготовитьМакетОтчета(ИмяФормы, МакетОтчета, ИмяРаздела, ПараметрыПодготовки) Экспорт
	...
	Если ИмяФормы = "ФормаОтчета2011Кв4" ИЛИ ИмяФормы = "ФормаОтчета2019Кв1" Тогда
