...
Функция ПриЗагрузкеОтчетаОРозничныхПродажах(Устройство, ДанныеОПродажах, Отказ, СообщениеОбОшибке) Экспорт
    ...
    СоответствиеСтавкиНДС.Вставить(МенеджерОфлайнОборудования.ПолучитьСтавкуНДС22(), Перечисления.СтавкиНДС.НДС22);
    //--1бит Феденков 26.01.2026
...
Функция СтавкаНДСОфлайнОборудование(Знач СтавкаНДС)
	...
	ИначеЕсли СтавкаНДС = Перечисления.СтавкиНДС.НДС22_122 Тогда
		Возврат МенеджерОфлайнОборудования.ПолучитьСтавкуНДС122();
	ИначеЕсли СтавкаНДС = Перечисления.СтавкиНДС.НДС22 Тогда
		Возврат МенеджерОфлайнОборудования.ПолучитьСтавкуНДС22();
	//--1бит Феденков 26.01.2026	
	Иначе
