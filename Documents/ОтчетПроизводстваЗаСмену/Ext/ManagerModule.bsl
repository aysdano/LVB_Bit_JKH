...
// 
Процедура ЗаполнитьМатериалыПоПродукцииУслугам(Материалы, Продукция, Услуги = Неопределено, Организация, Склад) Экспорт
...
Процедура ЗаполнитьВидОперацииПоУмолчанию(Параметры) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		ЭлементБлокировки = Блокировка.Добавить("Документ.ОтчетПроизводстваЗаСмену");
