...
Процедура ДополнитьПараметры_2020(Параметры)
	Для Каждого Стр Из Параметры.ДанныеМногостраничныхРазделов.Транспорт Цикл 
		Стр.Значение.Вставить("ДатаГибелиТСВыгр", Формат(Стр.Значение.ДатаГибелиТС, "ДФ=MM.yyyy"))
	КонецЦикла;
КонецПроцедуры
