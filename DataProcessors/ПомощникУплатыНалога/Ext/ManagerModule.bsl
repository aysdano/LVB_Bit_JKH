...
Функция ДанныеБаннераБлокРасчет(ПараметрыЗадачи) Экспорт
	...
	Если НалоговыйУчет.ВидимостьБаннераАнтикризис(Организация, КодЗадачи, ПериодСобытия) Тогда
		
		ОписаниеБаннера.ИдентификаторБаннера = "АнтикризисНастройкиНалоговИОтчетов";
		ОписаниеБаннера.Сообщение = 
			НалоговыйУчет.ТекстБаннераНастройкиНалоговИОтчетов(Организация, КодЗадачи);
			
	ИначеЕсли УправлениеВнеоборотнымиАктивами.ВидимостьБаннераОтменаДекларацииПоНалогу(
		 КодЗадачи,
		 ПериодСобытия) Тогда
		 
		ОписаниеБаннера.ИдентификаторБаннера = "ОтменаДекларацииПоТранспортномуЗемельномуНалогу";
		ОписаниеБаннера.Сообщение = 
			УправлениеВнеоборотнымиАктивами.ТекстБаннераОтменаДекларацииПоНалогу(КодЗадачи);
...
Функция ДанныеБаннераБлокУплата(ПараметрыЗадачи) Экспорт
	...
	Если УправлениеВнеоборотнымиАктивами.ВидимостьБаннераИзменениеСроковУплатыНалога(
		 КодЗадачи,
		 ПериодСобытия) Тогда
		 
		ОписаниеБаннера.ИдентификаторБаннера = "ИзменениеСроковУплатыТранспортногоЗемельногоНалога";
		ОписаниеБаннера.Сообщение = 
			УправлениеВнеоборотнымиАктивами.ТекстБаннераИзменениеСроковУплатыНалога(КодЗадачи);
...
Процедура СохранитьНастройкуВидимостиБаннера(Организация, КодЗадачи, ИдентификаторБаннера, ЗначениеНастройки) Экспорт
	...
	Если ИдентификаторБаннера = "АнтикризисНастройкиНалоговИОтчетов" Тогда
		НалоговыйУчет.СохранитьНастройкуБаннераАнтикризис(Организация, КодЗадачи, ЗначениеНастройки);
	ИначеЕсли ИдентификаторБаннера = "ОтменаДекларацииПоТранспортномуЗемельномуНалогу" Тогда
		УправлениеВнеоборотнымиАктивами.СохранитьНастройкуБаннераОтменаДекларацииПоНалогу(
			КодЗадачи,
			ЗначениеНастройки);
	ИначеЕсли ИдентификаторБаннера = "ИзменениеСроковУплатыТранспортногоЗемельногоНалога" Тогда
		УправлениеВнеоборотнымиАктивами.СохранитьНастройкуБаннераИзменениеСроковУплатыНалога(
			КодЗадачи,
			ЗначениеНастройки);
...
Функция СведенияОРасчетеСуммы(ПараметрыЗадачи)
	...
	СведенияОРасчете.БаннерБлокРасчет = ДанныеБаннераБлокРасчет(ПараметрыЗадачи);
...
Процедура СведенияПоУплатеСтраховыхВзносов(ПараметрыЗадачи, СведенияОРасчете)
	...
	// Суммы страховых взносов необходимо отображать с точностью до 2-х знаков.
	СведенияОРасчете.ФорматСумм = "ЧЦ=15; ЧДЦ=2; ЧН=";
...
Функция НовыйСведенияОРасчете()
	...
	СтруктураСведенийОРасчете.Вставить("ФорматСумм",             "ЧЦ=15;ЧН=");
