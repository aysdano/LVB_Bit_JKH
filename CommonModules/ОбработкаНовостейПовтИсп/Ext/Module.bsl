...
#Область ProductVersion
		...
		// В исключительных случаях (когда в бит_ОбщегоНазначенияПовтИсп.ПолучитьНомерРелиза_1С() записана нестандартная версия, например 1.2.3.4.5 или 1.2.3.4/5.6.7.8),
...
#Область МетаданныеВерсия
		...
		Результат = бит_ОбщегоНазначенияПовтИсп.ПолучитьНомерРелиза_1С();
