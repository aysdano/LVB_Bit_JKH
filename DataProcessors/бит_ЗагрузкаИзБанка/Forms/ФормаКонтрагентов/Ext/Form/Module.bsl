...
#Область ПроцедурыМеханизмаДлительныхОперций
...
Функция СоздатьНенайденное(ИБФайловая)
	...
	Если ИБФайловая Тогда
		...
		Обработки.бит_ЗагрузкаИзБанка.ФоноваяЗагрузкаКонтрагентов(СтруктураПараметров, АдресХранилища);
	...
	Иначе
		...
		Результат = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
			...
			"Обработки.бит_ЗагрузкаИзБанка.ФоноваяЗагрузкаКонтрагентов",
			СтруктураПараметров, 
			НаименованиеЗадания);
...
Процедура ЗагрузитьПодготовленныеДанныеНаКлиенте(СтруктураДанныхКлиента)
	...
	Если СтруктураДанныхКлиента.Свойство("МассивКонтрагентов")
		...
		ПоказатьОповещениеПользователя(
			...
			,,, БиблиотекаКартинок.бит_КлиентБанкКомандаЗагрузить);
...
#Область ПроцедурыОбработчикиСобытийТабличногоПоляДеревоКонтрагентов
