...
Функция ДеревоФормИФорматов() Экспорт
	...
	Форма20200101 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "609245", '20200715', "383", "ФормаОтчета2020Кв1");
	ВерсияВыгрузки = РегламентированнаяОтчетность.ПолучитьВерсиюВыгрузкиСтатОтчета("РегламентированныйОтчетСтатистикаФорма1ТЕП", "ФормаОтчета2020Кв1");
